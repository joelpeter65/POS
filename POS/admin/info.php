			...
			<div class="card">
				<div class="card-body">
					<form method="POST" action="#">
						...
						<input type="hidden" name="pID" value="<?php echo $pID;?>" class="form-control" id="inputCity" required="true">
						<input type="text" name="pname" value="<?php echo $pname;?>" class="form-control" id="inputCity" required="true">
						<label for="inputCity">Brand Name</label>
						<input type="text" name="bname" value="<?php echo $bname;?>" class="form-control" id="inputCity" required="true">
						<label for="inputCity">Product Number</label>
						<input type="text" name="pnmbr" value="<?php echo $pnmbr;?>" class="form-control" id="inputCity" required="true">
						...
						<input type="text" name="sprice" value="<?php echo $sprice;?>" class="form-control" id="inputCity" required="true">
